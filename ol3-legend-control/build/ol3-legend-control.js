// Generated by uRequire v0.7.0-beta.11 target: 'dev' template: 'combined'
...
define('openLayers',[],function () {
  if (__isNode) {
  return __nodeRequire('openLayers');
} else {
...
define('jquery',[],function () {
  ...
  return __nodeRequire('jquery');
    ...
    return (typeof $ !== 'undefined') ? $ : __throwMissing('jquery', '$')
}
});
...
if (__isAMD) {
  return define(['openLayers', 'jquery'], bundleFactory);
} else {
    if (__isNode) {
        return module.exports = bundleFactory(require('openLayers'), require('jquery'));
    } else {
        return bundleFactory((typeof ol !== 'undefined') ? ol : void 0, (typeof $ !== 'undefined') ? $ : void 0);
    }
}
